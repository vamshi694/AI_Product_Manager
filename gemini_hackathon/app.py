...
project_name = os.getenv("JIRA_PROJECT_KEY")

def main():
    bg_image = encode_image_url("https://media.istockphoto.com/id/685132245/photo/mature-businessman-smiling-over-white-background.jpg?s=1024x1024&w=is&k=20&c=DVMnVqNdEdAJ36bvPGvwp-TY5NHOm_4ayk9pxyUnHn4=") #Initail background image
    with st.sidebar:
        st.title("Dylan")
        ...
        #Prompt to tune the model's response
    ...
    if user_query and chat_model_response_text:
        ...
        generate_video(chat_model_response_text, "https://media.istockphoto.com/id/685132245/photo/mature-businessman-smiling-over-white-background.jpg?s=1024x1024&w=is&k=20&c=DVMnVqNdEdAJ36bvPGvwp-TY5NHOm_4ayk9pxyUnHn4=")
    ...
    if end_conv and conv_history != []:
        ...
        if classify_conv == "New product idea":
            ...
            #Emails the conversation summary and next steps file to the user
